...
public class CMD extends Panel implements KeyListener {
    ...
    public CMD(){
        ...
        ta.append("Title: Molecule Verctual OS\n");
    ...
    protected void edit(KeyEvent ke){
        ...
        if(c=='\n'){
            if(commandEnter.equals("exit")){
                ...
                editOn = false;
                ta.append(currentPath+prompt);
                myFrame.setTitle("Molecule (CMD Console) - Type 'help' or '?' for Help");
            }
    ...
    protected void commandControl(KeyEvent ke){
        ...
        if(c=='\n'){
            ...
            if(commandEnter.startsWith("urlinfo") || commandEnter.startsWith("urlinfo ")){
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try{
                        ...
                        ta.append("Content/Typed: "+hpCon.getContentType()+"\n");
                        ...
                        String  serverNotFind= "";
                         serverNotFind= token;
                        ta.append("Error; can't find server '"+serverNotFind+"'\n");
                        ta.append("Usage: urlinfo http://"+serverNotFind+"\n");
                    }
            ...
            if(commandEnter.startsWith("run") || commandEnter.startsWith("run ")){
                int runError = 0;
                ta.setEditable(true);
                ta.append(commandEnter+"\n");
                ta.setEditable(false);
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try{
                        ...
                        connotRunFile = token;
                        ta.append("Error; can't run program '"+connotRunFile+"'\n");
                    }
                }
            ...
            /////////////////////////////// WHOIS //////////////////////////////////////////
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try{
                        ...
                        String connotFindWhois="";
                        connotFindWhois = token;
                        ta.append("Error; can't find server '"+connotFindWhois+"'\n");
                    }
                }
                //s.close();
                ta.append(currentPath+prompt);
            ...
            /////////////////////////////// Directory(DIR) //////////////////////////////////////////
                ...
                try{
                    ...
                    for(j=0; j<=fileNames.length; j++){
                        ...
                        //ta.append(fileNames[j]+" , "+"("+fileSie+" bytes)\n");
                        ta.append(fileNames[j]+"\n");
                        //if(fileSize==0)
                        //ta.append(fileNames[j]+" , "+" (dir)\n")
                        //}else{
            ...
            /////////////////////////////// Change Directory //////////////////////////////////////////
                ...
                try{
                    ...
                    if(cd.exists()==true)
                        currentPath = path;
                    if(cd.exists()==false)
                        ta.append("Error: File doesn't exist\n");
                }catch(Exception e){
            ...
            else if(commandEnter.startsWith("del") || commandEnter.startsWith("del ")) {
            ...
            /////////////////////////////////////// EDIT ///////////////////////////////////////
                ...
                //ta.setText("");
                editOn = true;
                myFrame.setTitle("CMD Console-Edit Mode (Type 'exit' to quit)-"+currentFile);
                ta.requestFocus();
            }
            /////////////////////////////////////// LOCAL DATE ///////////////////////////////////////
                ...
                try{
                    ...
                    ta.append("Usage: local -uk (United Kingdom)\n");
                    ta.append("Usage: local -gr (Germany)\n");
                    ta.append("Usage: local -fr (France)\n");
                    ta.append("Usage: local -ca (Canada)\n");
                    ta.append("Usage: local -it (Italy)\n");
                    ta.append("Usage: local -ch (China)\n");
                    ta.append("Usage: local -kr (Koria)\n");
                    ta.append("Usage: local -jp (Japan)\n");
            ...
            /////////////////////////////////////// SORT ///////////////////////////////////////
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try{
                        ...
                        ta.append("Error: Can't execute 'sort' command\n");
                    }
                }
            ...
            /////////////////////////////////////// OS Information ///////////////////////////////////////
                ...
                ta.append("OS Resistered to: "+user_Name+"\n");
                ta.append("OS Installation: "+user_Home+"\n\n");
                ta.append(currentPath+prompt);
                ta.setEditable(false);
            }
            ...
            else if(commandEnter.equalsIgnoreCase("")) {
                ta.append("\n");
                ta.append(currentPath+prompt);
                tf.requestFocus();
            }
            ...
            ///////////////////////////////////////  Help   ///////////////////////////////////////
                ...
                ta.append(" show     | Show files content        |  show readme.txt\n");
                ta.append(" osinfo   | OS Information            |  osinfo\n");
                ta.append(" exit     | Exit from Edit Mode       |  exit\n");
                ta.append(" help     | Shows help information    |  help\n");
                ta.append(" ?        | Showa help information    |  ?\n");
                ta.append(" whois    | Gives information of sites|  whois internic.net dotcom.com\n");
                ta.append(" quit     | Quits CMD/ Edit mode      |  quit\n\n");
    ...
    public static void main(String[] args){
        myFrame = new Frame("Molecule (CMD Console)-Type 'help' or '?' for Help");
        CMD cmd = new CMD();
        myFrame.add(cmd);
