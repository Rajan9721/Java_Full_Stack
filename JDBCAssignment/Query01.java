...
class CreateFirstForm {
	...
	CreateFirstForm() {
		...
		j11 = new JLabel("Table to be Queried ");
		j11.setBounds(40, 10, 200, 25);
		jf1.add(j11);
		...
		j12 = new JLabel("Criteria ");
		j12.setBounds(40, 350, 200, 25);
		jf1.add(j12);
		
		j13 = new JLabel("Fields:");
		j13.setBounds(40, 400, 200, 25);
		jf1.add(j13);
		
		j14 = new JLabel("Operators: ");
		j14.setBounds(40, 435, 200, 25);
		jf1.add(j14);
		
		j15 = new JLabel("Value:");
		j15.setBounds(40, 470, 200, 25);
		jf1.add(j15);
...
class QueryEvent implements ActionListener {
	...
	public void actionPerformed (ActionEvent ae)
	{
		...
		if (ae.getSource() == cff.jb1)
		{
			...
			//will set column names into jList2
			...
			try
			{
				...
				System.out.println(" Query Event Table does notExist");
			}catch(Exception e){
	...
	/////////////////////////////////////////////////////////////////////////////////////////
		if (ae.getSource() == cff.jb2)
		{
			...
			for(int i=0;i<10;i++)
				sel[i]=0;
			int count=0;
			// count stores no. of elements in jList144
	...
	//////////////////////////////////////////////////////////////////////////
		if (ae.getSource()==cff.jb3)
		{
			...
			int count=0;
			// count stores no of elements in jList2
...
/////////////////////////////////////////////////////////////////////////////////////
		...
		if(ae.getSource()==cff.jcb1)
		{
			...
			cff.jcom1.insertItemAt("---None---",0);
			cff.jcom1.setSelectedIndex(0);
			cff.jcom1.setBounds (150,40,200,25);
		...
		{
			if(cff.jcom1.getSelectedItem().toString().equals("---None---")==false)
			{
...
class Connect {
	...
	// static Vector dbNames = new Vector(0, 1);
	...
	public void connectDSN() {
		...
		try {
			...
			dsnName = new String("jdbc:mysql://localhost:3306/" + dsnName);
			Class.forName("com.mysql.cj.jdbc.Driver");
			Connection c = DriverManager.getConnection(dsnName,"root","0170");
			Statement s = c.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
